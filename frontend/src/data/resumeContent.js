...
export const RESUME_SKILLS = {
  ...
  ai: [
    ...
    "RAG pipelines — Amazon Bedrock (Llama 3 70B) · Titan Embeddings · AWS Glue · ChromaDB · Ollama",
...
export const RESUME_ACHIEVEMENTS = [
  ...
  },
  {
    ...
    detail:
      "Architected a production RAG pipeline for the data analytics team — AWS Glue ETL for Aurora/RDS metadata ingestion, Amazon Titan Embeddings for semantic search, and Amazon Bedrock (Llama 3 70B) for LLM inference. Built reusable Terraform blueprints for Informatica cluster deployments, ECS/Fargate ETL pipelines, Aurora/RDS provisioning, EFS/EBS lifecycle automation, and Datadog observability.",
    icon: "spark",
  },
];
